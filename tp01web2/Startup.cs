...
namespace tp01web2
{
    class Startup
    {
        ...
        public Task GerarHtml(HttpContext context)
        {
            ArquivoCSV arq = new ArquivoCSV();
            var books = arq.buscarNomes();
            var pHtml = "<div><h1>TP01</h1><h2>Prof:</h2><p>Wellington Tuler</p> <h2>Dupla:</h2><p>Igor Nicolas Parada - ADS571 - CB3002454</p><p>Lorrane Meneses - ADS571 - CB3002519</p></div><div><h1>Nome do Livro: </h1><p>" + books[0].Name+"</p><h2>Autor(es)</h2><p>"+books[0].getAuthorNames()+"</p></div>";
